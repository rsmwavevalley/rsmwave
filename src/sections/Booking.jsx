          ...
          <AnimatePresence mode="wait">
            ...
            {(bookingState === BOOKING_STATES.DRAFT || bookingState === BOOKING_STATES.PAYMENT_FAILED) && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Dynamic Pricing Configulator Card */}
                  <div className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-2xl p-6 shadow-xl flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-xs font-bold uppercase tracking-widest opacity-80">Admission Quote</span>
                        <span className="bg-white/20 text-xs px-2.5 py-1 rounded-full font-bold">₹{pricingConfig.ticketPrice || 650}/Guest</span>
                      </div>
                      <h4 className="text-3xl font-black">₹{totalAmount}</h4>
                    </div>
                    <p className="text-xs opacity-75 mt-4">
                      Price calculated dynamically. Local sales tax included. Weekend/holiday pricing applied automatically at checkout.
                    </p>
                  </div>
